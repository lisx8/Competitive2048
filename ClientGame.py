...
server_name = '192.168.2.16' #IP ADDRESS OF YOUR SERVER HERE
server_port = 8888
...
while game_running:
    if(dir != 'p'): #If Player 2 wasn't forced to pass by Player 1.
        list_grid = []
        for i in range(0, 4):
            for j in range(0, 4):
    ...
    if(decoded_grid == 'q'): #If Player 1 has chosen to quit.
        game_running = False
        print("QUIT")
    elif(decoded_grid == 'p'): #If Player 1 has forced Player 2 to pass.
        pass
    elif(decoded_grid == 'o'): #If Player 1 created a game over.

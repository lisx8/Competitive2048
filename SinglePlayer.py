...
mySurface = pygame.Surface((800, 1000))
mySurface.fill(orange)
...
def draw_rect(x, y, value, color):
    rectangle = pygame.Rect(x_locations[y], y_locations[x], rec_width, rec_width)
    rec = pygame.draw.rect(mySurface, color, rectangle)
    gameDisplay.blit(mySurface, (0, 0))
    pygame.display.update()
